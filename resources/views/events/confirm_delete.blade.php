                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body text-center p-4">
                            ...
                            <h4 class="text-danger mb-20">Delete Event</h4>
                            <p class="mb-4 mx-4">Are you sure you would like to delete this Event post entirely?</p>

                            @if ($event)
                            <form action="{{ route('deletePost.events')}}" method="POST">
                                @csrf
                                @method('DELETE')
                                <input type="hidden" name="id" value="{{$event->id}}">
                                <a href="{{ route('index.events') }}" class="btn btn-primary pd-x-25">Cancel</a>
