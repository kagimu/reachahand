    ...
    <div class="row pb-4">
                ...
                <div class="widget-user-image d-sm-flex">
                    ...
                    <div class="ml-sm-4 mt-4">
                        ...
                        <div class="d-flex mb-1">
                            ...
                            <div class="h6 mb-0 ml-3 mt-1">The Time Property was Created: {{$impact->created_at}}</div>
                        </div>
                        <div class="d-flex">
                            <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                                width="24">
                            ...
                            <div class="h6 mb-0 ml-3 mt-1">Username: {{$impact->user->username}}</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-5">
            ...
            <div class="row">
                ...
                @if (is_string($impact->video))
                <div class="col-6">
                    <div class="embed-responsive embed-responsive-16by9 mb-3">
                        <video class="embed-responsive-item" controls>
                            <source class="embed-responsive-item" src="{{ asset('storage/' . $impact->video) }}"
