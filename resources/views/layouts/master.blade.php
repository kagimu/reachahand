    ...
    <div class="page-main">
        ...
        <aside class="app-sidebar app-sidebar3">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" href="{{route('index.posts')}}">
                        ...
                        <span class="side-menu__label">Posts</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="{{route('index.categories')}}">
                ...
                <li class="slide">
                    <a class="side-menu__item" href="{{route('index.clients')}}">
                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                             viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                             stroke-linecap="round" stroke-linejoin="round">
                ...
                <li class="slide">
                    <a class="side-menu__item" href="{{route('index.support')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                             class="side-menu__icon">
                            <path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"></path>
                        </svg>
                        <span class="side-menu__label">Support Admin</span></a>
                    </li>
                <li class="slide">
                    <a class="side-menu__item" href="{{route('index.agents')}}">
                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                             viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                             stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="dropdown  header-option">
                                <a class="nav-link icon p-0" data-toggle="dropdown">
                                    <span class="nav-span"><h3 style="margin-top: 20px;">ADMIN PANEL</h3></span>
                                </a>
                            </div>
                                ...
                                <div class="dropdown profile-dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                                        <div class="text-center">
                                            <a href="#"
                                               class="dropdown-item text-center user pb-0 font-weight-bold">{{Auth::user()->first_name . " " .Auth::user()->last_name}}</a>
