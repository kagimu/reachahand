                    ...
                    <div class="widget-user-image d-sm-flex">
                        ...
                        <div class="ml-sm-4 mt-4">
                            ...
                            <div class="d-flex mb-1">
                                ...
                                <div class="h6 mb-0 ml-3 mt-1">{{$post->created_at}}</div>
                            </div>
                            <div class="d-flex">
                                ...
                                <div class="h6 mb-0 ml-3 mt-1">{{$post->user->phone}}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-inner">
                        @foreach($post->images as $image)
                            <div class="carousel-item active">
                                ...
                                <img class="d-block w-100" alt="" src="{{$image}}" data-holder-rendered="true">
