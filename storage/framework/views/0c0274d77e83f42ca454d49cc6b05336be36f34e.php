...
<div class="col-lg-12">>
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Add Impact</h4>
        </div>
        <div class="pull-right">
            <a class="btn btn-primary" href="<?php echo e(route('index.impacts')); ?>"> Back</a>
        </div>
        ...
        <?php endif; ?>
        <div class="card-body">
            <form action="<?php echo e(route('store.impacts')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="alert alert-danger mt-4 mb-0"><?php echo e($message); ?></div>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <button type="submit" class="btn btn-primary mt-5 mb-0">Create Impact</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/Documents/react/Reachahand_backend/resources/views/impacts/create.blade.php ENDPATH**/ ?>