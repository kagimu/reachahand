...
<div class="col-lg-12">>
    <div class="card">
        ...
        <div class="pull-right">
            <a class="btn btn-primary" href="<?php echo e(route('index.programs')); ?>"> Back</a>
        </div>
        ...
        <?php endif; ?>
        <div class="card-body">
            <form action="<?php echo e(route('store.programs')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/Documents/ALL/react/Reachahand_backend/resources/views/programs/create.blade.php ENDPATH**/ ?>