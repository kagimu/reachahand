...
<head>
    ...
    <!-- Title -->
    <title><?php echo e(config('app.name')); ?> | <?php echo e(session('title')); ?></title>
                                ...
                                <div class="d-flex order-lg-2 ml-auto">
                                    ...
                                    <div class="dropdown profile-dropdown">
                                        <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                            <span>
                                                <img src="<?php echo e(Auth::user()->image ? asset(Auth::user()->image) : asset('images/placeholder.png')); ?>"
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 mt-3 mt-lg-0 text-center">
                        Copyright © 2023 <a href="#"><?php echo e(config('app.name')); ?></a>. Designed by <a href="#">JAYP UG</a>
                        All rights reserved.
                    </div>
                </div>
            </div>
...
</html><?php /**PATH /home/user/Documents/react/Reachahand_backend/resources/views/layouts/master.blade.php ENDPATH**/ ?>