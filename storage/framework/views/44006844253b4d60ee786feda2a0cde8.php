    ...
    <div class="row pb-4">
        <div class="col-lg-7">
            <div class="box-widget widget-user">
                <div class="widget-user-image d-sm-flex">
                    <img src="<?php echo e($event->user->profile_pic_url ? asset($event->user->profile_pic_url) : asset('images/placeholder.png')); ?>"
                        alt="img" class="img-fluid" style="max-width: 25%; max-height: 50%; border-radius:40px;">
                    <div class="ml-sm-4 mt-4">
                        <h4 class="pro-user-username mb-3 font-weight-bold"><?php echo e($event->user->name); ?> <?php if($event->user->role
                        ...
                        <div class="d-flex mb-1">
                            ...
                            <div class="h6 mb-0 ml-3 mt-1">The Time Property was Created: <?php echo e($event->created_at); ?></div>
                        </div>
                        <div class="d-flex">
                            <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                                width="24">
                            ...
                            <div class="h6 mb-0 ml-3 mt-1">Username: <?php echo e($event->user->username); ?></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <?php if($event->other_images): ?>
                            <?php $__currentLoopData = $event->other_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row">
               ...
               <?php if(is_string($event->main_image)): ?>
                <div class="col-8">
                    <div class="embed-responsive embed-responsive-16by9 mb-3">
                        <div class="col-md-8 mb-3">
                            <img src="<?php echo e(asset('storage/' . $event->main_image)); ?>" alt="Image" class="img-fluid"
                                style="max-width: 100%; max-height: 100%; border-radius:8px;">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/Documents/react/Reachahand_backend/resources/views/events/show.blade.php ENDPATH**/ ?>