...
<div class="col-lg-12">>
    <div class="card">
        ...
        <div class="card-header">
            <a class="btn btn-primary" href="<?php echo e(route('index.impacts')); ?>" enctype="multipart/form-data"> Back</a>
        </div>
        ...
        <?php endif; ?>
        <div class="card-body">
            <form action="<?php echo e(route('update.impacts', $impact->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="form-group">
                    <label for="title" class="form-label">Title:</label>
                    <input type="text" name="title" class="form-control" placeholder=""
                        value="<?php echo e(old('title', $impact->title)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc" rows="4" cols="30" class="form-control tinymce-editor"
                        required><?php echo e(old('desc', $impact->desc)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tag" class="form-control" placeholder="#"
                        value="<?php echo e(old('tag', $impact->tag)); ?>">
                    <?php $__errorArgs = ['tag'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location" class="form-control" placeholder=""
                        value="<?php echo e(old('location', $impact->location)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="owner" class="form-control" placeholder=""
                        value="<?php echo e(old('owner', $impact->owner)); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/Documents/react/Reachahand_backend/resources/views/impacts/edit.blade.php ENDPATH**/ ?>