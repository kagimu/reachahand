...
<div class="col-lg-12">>
    <div class="card">
        ...
        <div class="card-header">
            <a class="btn btn-primary" href="<?php echo e(route('index.posts')); ?>" enctype="multipart/form-data"> Back</a>
        </div>
        ...
        <?php endif; ?>
        <div class="card-body">
            <form action="<?php echo e(route('update.posts', $post->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc" rows="4" cols="30" class="form-control tinymce-editor"
                        required><?php echo e(old('desc', $post->desc)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tag" class="form-control" placeholder="#"
                        value="<?php echo e(old('tag', $post->tag)); ?>">
                    <?php $__errorArgs = ['tag'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location" class="form-control" placeholder=""
                        value="<?php echo e(old('location', $post->location)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="owner" class="form-control" placeholder=""
                        value="<?php echo e(old('owner', $post->owner)); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/Documents/ALL/react/Reachahand_backend/resources/views/posts/edit.blade.php ENDPATH**/ ?>