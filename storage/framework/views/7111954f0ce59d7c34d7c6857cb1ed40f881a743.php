...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label for="status" class="form-label">What do you want to do with the Property? (For now, leave it
                        as Rental)</label>
                    <select name="status" id="status" class="form-control">
                        <option value="rental" <?php echo e($report->status == 'rental' ? 'selected' : ''); ?>>Rental</option>
                        <option value="for sale" <?php echo e($report->status == 'for sale' ? 'selected' : ''); ?>>For Sale</option>
                    </select>
