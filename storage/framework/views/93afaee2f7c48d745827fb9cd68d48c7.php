                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body text-center p-4">
                            ...
                            <?php if($post): ?>
                            <form action="<?php echo e(route('deletePost.posts')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <input type="hidden" name="id" value="<?php echo e($post->id); ?>">
                                <a href="<?php echo e(route('index.posts')); ?>" class="btn btn-primary pd-x-25">Cancel</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/Documents/react/Reachahand_backend/resources/views/posts/confirm_delete.blade.php ENDPATH**/ ?>