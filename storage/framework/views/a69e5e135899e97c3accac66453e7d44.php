    ...
    <div class="row pb-4">
        <div class="col-lg-7">
            <div class="box-widget widget-user">
                <div class="widget-user-image d-sm-flex">
                    <img src="<?php echo e($post->user->profile_pic_url ? asset($post->user->profile_pic_url) : asset('images/placeholder.png')); ?>"
                        alt="img" class="img-fluid" style="max-width: 25%; max-height: 50%; border-radius:40px;">
                    <div class="ml-sm-4 mt-4">
                        <h4 class="pro-user-username mb-3 font-weight-bold"><?php echo e($post->user->name); ?> <?php if($post->user->role
                        ...
                        <div class="d-flex">
                            ...
                            <div class="h6 mb-0 ml-3 mt-1">Username: <?php echo e($post->user->username); ?></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-5">
                            ...
                            <?php $__currentLoopData = $post->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(is_string($image)): ?>
                                    <div class="col-md-6 mb-3">
                                        <img src="<?php echo e(asset('storage/' . $image)); ?>" alt="Image" class="img-fluid" style="max-width: 100%; max-height: 100%; border-radius:8px;">
                                    </div>
                                <?php endif; ?>
            ...
            <div class="row">
                ...
                <?php if(is_string($post->cover_pic_url)): ?>
                <div class="col-6">
                    <div class="embed-responsive embed-responsive-16by9 mb-3">
                        <img src="<?php echo e($post->cover_pic_url ? asset($post->cover_pic_url) : asset('images/placeholder.png')); ?>"
                        alt="img" class="img-fluid" style="max-width: 25%; max-height: 50%; border-radius:40px;">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/Documents/ALL/react/Reachahand_backend/resources/views/posts/show.blade.php ENDPATH**/ ?>