        ...
        <div class="col-lg-7">
            <div class="box-widget widget-user">
                <div class="widget-user-image d-sm-flex">
                    <img alt="avatar" class="rounded-circle border p-0" src="<?php echo e($post->user->profile_pic_url); ?>"
                        height="70" width="70">
                ...
                <div class="col-6">
                    <div class="embed-responsive embed-responsive-16by9 mb-3">
                        <video class="embed-responsive-item" controls>
                            <source class="embed-responsive-item" src="<?php echo e(asset('storage/' . $post->video)); ?>"
